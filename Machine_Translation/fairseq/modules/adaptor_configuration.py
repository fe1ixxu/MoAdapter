...
from fairseq.modules.adaptor_composition import AdapterCompositionBlock  #adaptor_composition
from fairseq.modules.adaptor_utils import get_adapter_config_hash, resolve_adapter_config  #adaptor_utils
